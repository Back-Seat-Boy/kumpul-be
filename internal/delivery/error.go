...
func CustomHTTPErrorHandler(err error, c echo.Context) {
	...
	case errors.Is(err, model.ErrForbidden):
		...
		message = "Forbidden"
	case errors.Is(err, model.ErrInviteOnlyRequiresLink):
		code = http.StatusForbidden
		message = err.Error()
	case errors.Is(err, model.ErrInvalidEmail) || errors.Is(err, model.ErrInvalidGoogleID) ||
		...
		errors.Is(err, model.ErrSkipVotingRequiresOneOption) || errors.Is(err, model.ErrEventScheduleEditNotAllowed) ||
